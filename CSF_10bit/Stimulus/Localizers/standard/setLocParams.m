function params = setLocParams(expName, params)
...
if ~isempty(params.calibration)
    params.display.cmapDepth  =  16; %obsolete, loading params set cmapDepth to 10
...
%                                         255 255 255 255];
        params.display.fixColorRgb = [0 0 0 0; ...
                                      65536 65536 65536 65536]; % 16 bit, b/w
