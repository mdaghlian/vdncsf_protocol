...
switch handles.data.experiment,
    ...
    case {'Translating Bars 8 Pass (Dumoulin)'},
        ...
        handles.data.numCycles = 1;
        set(handles.numCycles, 'String','1');    %#
        handles.data.period    = 282;
        set(handles.period,    'String','282');   %seconds
        handles.data.prescanDuration = 12;
        set(handles.prescanDuration,    'String','12');   %seconds
        
        disp(sprintf('[%s]:WARNING: when setting experiment to %s, num Cycles (%d) and period (%d) and others have been changed as well!',...
            mfilename,handles.data.experiment,handles.data.numCycles,handles.data.period));
    case {'Translating Bars stereo (at fixation)', 'Translating Bars stereo (far)', 'Translating Bars interleave', 'Translating Bars vertical'},
        handles.data.savestimparams = 1;
        set(handles.savestimparams, 'Value',1); 
        handles.data.tr = 1.5;
        set(handles.tr, 'String','1.5');
    ...
    case {'Dot-defined 3D bar no noise',...
          'Dot-defined 3D bar with noise',...
          'Dot-defined 2D bar no noise',...
          'Dot-defined 2D bar with noise','Stereo Calibration','Retinotopy'}
        handles.data.savestimparams = 1;
        set(handles.savestimparams, 'Value',1); 
        handles.data.tr = 1.5;
        set(handles.tr, 'String','1.5');
        ...
        handles.data.prescanDuration = 12;
        set(handles.prescanDuration,    'String','12');   %seconds
        handles.data.stimSize  = 4.5;
        set(handles.stimSize,  'String','4.5');
        % set(handles.stimSize,  'String','6');
        handles.data.calibration       = '7T_DLP_1600x900';
        set(handles.calibration(1),'Value',2);  

    case {'3D speed experiment'}
        handles.data.savestimparams = 1;
        set(handles.savestimparams, 'Value',1); 
        handles.data.tr = 1.5;
        set(handles.tr, 'String','1.5');
        ...
        set(handles.stimSize,  'String','6');
        % set(handles.stimSize,  'String','6');
        handles.data.calibration       = 'Stereo_7T_projector_UMC_1024x768';
        set(handles.calibration(1),'Value',2); 
    ...
    case {'Scotoma stimulus','Localizer','Vertical motion'}
        ...
        handles.data.numCycles = 1;
        set(handles.numCycles, 'String','1');    %#
        handles.data.period    = 444;
        set(handles.period,    'String','444');   %seconds
