...
% Wow, this stuff is jacked. 
% CalibrateMonitorPhotometer seems to show the last value is clipped to 255
...
%%%% LEFT EYE SCREEN %%%%
% BR: Why are you normalizing?
% Can you point to the example you used?
measL = leftEyeMeasurements;
maxIndex = max(rgb); %255;
indexNormal = [0:0.001:1]';
maxLum = max(measL); % measL(size(measL,1),2);
...
[out1 params1 message1] = FitGamma(rgb, measL, indexNormal,1);
