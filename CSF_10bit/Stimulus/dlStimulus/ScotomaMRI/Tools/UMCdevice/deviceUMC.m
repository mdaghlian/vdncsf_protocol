function [output t0 display] = deviceUMC(command,port, display)
...
switch(lower(command))
    ...
    case {'open','start'}
        ...
        %IOPort('OpenSerialPort',id.device,'9600,n,8,1');

    case {'read'}
        output = SerialComm('read',id.device);%IOPort('read',id.device);%
...
%                 WaitSecs(0.01);
    ...
    case {'close'}
        ...
        SerialComm('close',id.device);%IOPort('close',id.device);%
