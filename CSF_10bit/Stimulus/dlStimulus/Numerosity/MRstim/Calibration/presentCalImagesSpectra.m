function presentCalImagesSpectra
...
% default parameters
params.duration     = []; % seconds Empty = button press
params.nimages      = 9;
%params.nindex       = fliplr(round(linspace(0,255,params.nimages)));%[0:256/(params.nimages-1)]*(params.nimages-1);
params.nindex       = [162   179   130];%fliplr(round(linspace(0,255,params.nimages)));%[0:256/(params.nimages-1)]*(params.nimages-1);
...
%            [params.timing(n) color];
            t0 = GetSecs;
            while getSecs-t0 < params.duration,
