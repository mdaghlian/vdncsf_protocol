function [stimulus params]= makeRetinotopyStimulus_naturalImages(params)
...
%    disp(sprintf('[%s]:size stimulus: %dx%d pixels.',mfilename,n,m));
    ...
    for ii=1:presentationsPerImage
        params.experiment
        switch params.experiment
            case{'Natural Images Grid 3 Flashes', 'Natural Images Grid 3 Flashes_set2', 'Natural Images Grid 3 Flashes_set3', 'Natural Images 3 Flashes_set1','Natural Images 3 Flashes_set2','Natural Images 3 Flashes_set3','Natural Images 3 Flashes_set4', 'Natural Images 3 Flashes_set5', 'Natural Images 3 Flashes_set6'}
                imageShowCycle=1:differentImages-5;
                imageShowCycle(end+1)=20;
                whichRun
                naturalimg(20).image= naturalimg(19+whichRun).image;
                tmp=rand(1,length(imageShowCycle));
                [tmp index]=sort(tmp);
                imageShowCycle=imageShowCycle(index);
                imageShowInserts=zeros(1, differentImages);
                
                %Inserts blank periods evenly through image cycle
                imageShowInserts(1:2)=imageShowCycle(1:2);
                imageShowInserts(3)=16;
                imageShowInserts(4:7)=imageShowCycle(3:6);
                imageShowInserts(8)=17;
                imageShowInserts(9:12)=imageShowCycle(7:10);
                imageShowInserts(13)=18;
                imageShowInserts(14:17)=imageShowCycle(11:14);
                imageShowInserts(18)=19;
                imageShowInserts(19:20)=imageShowCycle(15:16);                
                imageShowCycle=imageShowInserts;
    ...
    switch params.experiment
        case{'Natural Images Grid 3 Flashes', 'Natural Images Grid 3 Flashes_set2', 'Natural Images Grid 3 Flashes_set3'}
    ...
    for imageShowsCounter=1:imageShows
        ...
        for ff=1:imageOn
            switch params.experiment
                ...
                case{'Natural Images 3 Flashes', 'Natural Images 3 Flashes_set1','Natural Images 3 Flashes_set2','Natural Images 3 Flashes_set3', 'Natural Images 3 Flashes_set4', 'Natural Images 3 Flashes_set5', 'Natural Images 3 Flashes_set6'}
