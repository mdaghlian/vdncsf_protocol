function [stimulus otherSequence] = makeRetinotopyStimulus_barsGrid(params)
...
blankTime=5;       %Blank time (in seconds) will be rounded up to the nearest TR
