function [stimulus otherSequence] = makeRetinotopyStimulus_barsTR3(params)
...
%    disp(sprintf('[%s]:size stimulus: %dx%d pixels.',mfilename,n,m));
    ...
    for imgNum=1:halfNumImages
        ...
        if remake_xy(imgNum) >=0,
            ...
            switch params.experiment
                case {'8 bars','8 bars with blanks','8 bars (slow)','8 bars with blanks (attn)','8 bars with blanks (lr)','8 bars with blanks (lr 2)', '8 bars with blanks (lr 3)', '8 bars with blanks (tr 3)'}
