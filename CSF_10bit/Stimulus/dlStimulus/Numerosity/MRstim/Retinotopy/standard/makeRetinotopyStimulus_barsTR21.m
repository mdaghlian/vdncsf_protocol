function [stimulus otherSequence] = makeRetinotopyStimulus_barsTR21(params)
...
blankTime=25.2;       %Blank time (in seconds) will be rounded up to the nearest TR
...
if params.insertBlanks.do,
    if blanksAfterPass==1
        ...
        offPeriod = round(offTime./duration.stimframe);
