function stimulus = makeRetinotopyStimulus_checkSpeedECoG(params)
...
offTimes=[6 4.5 4.5 3.5 3.5 4 3.5 4 4.5 4 3.5 3.5 3 4 3 4 3.5 3.5 4.5 3 3 4 3.5 3.5 4.5 3 4.5 3 3 3 3 4.5 3 4 3 4 3.5 3.5 4 4 4.5 4 3 4.5 4 3.5 4.5 3.5 4.5 4 3 3 4.5 3.5 4.5];
...
onOffSequence=[onOffSequence(1:end-1)];
...
%Intermixed speeds for ECoG
speedSequence=[1 3 5 1 5 3 5 3 5 3 5 3 5 5 3 1 3 3 1 1 1 1 5 3 3 3 3 5 3 5 1 5 5 1 3 3 1 1 5 1 1 1 5 1 5 1 1 3 3 1 5 3 5 5];
...
sequenceCycle=sequence(1:(params.temporal.motionSteps*params.temporal.frequency));
for insertCounter=1:length(onOffSequence)
    if insertCounter==1
        sequence(1:onOffSequence(1))=add;
    elseif mod(insertCounter,2)==1
        sequence(onOffSequence(insertCounter-1)+1:onOffSequence(insertCounter))=add;
    else
        onNumber=insertCounter/2;
        insert=sequenceCycle(speedSequence(onNumber):speedSequence(onNumber):length(sequenceCycle));
        insert=repmat(insert, [1 speedSequence(onNumber)]);
        sequence(onOffSequence(insertCounter-1)+1:onOffSequence(insertCounter))=insert;
    end
end
