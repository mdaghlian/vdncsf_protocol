...
%d.fixColorRgb=[255 0 0 255; 0 0 255 255];
...
%         Screen('gluDisk', d.windowPtr, [255 255 255], d.fixX, d.fixY, d.fixSizePixels(2));
%         Screen('gluDisk', d.windowPtr, d.fixColorRgb(colIndex,:), d.fixX, d.fixY, d.fixSizePixels(1));
        Screen('gluDisk', d.windowPtr, d.backColorRgb, d.fixX, d.fixY, d.fixSizePixels+3); % The +3 is NOW HARDCODED! CHANGE WHEN FIND OUT WHERE TO DO SO!
        Screen('gluDisk', d.windowPtr, d.textColorRgb, d.fixX, d.fixY, d.fixSizePixels+2); % The +2 is NOW HARDCODED! CHANGE WHEN FIND OUT WHERE TO DO SO!
        Screen('gluDisk', d.windowPtr, d.fixColorRgb(colIndex,:), d.fixX, d.fixY, d.fixSizePixels);
